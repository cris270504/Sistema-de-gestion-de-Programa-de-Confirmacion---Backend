...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('justificaciones', function (Blueprint $table) {
            ...
            $table->enum('estado',['injustificado','pendiente','justificado']); //Por defecto debe ser injustificado. Si el padre se acerca a conversar y se acuerda cómo justificará la falta, se llena el campo descripción y el estado cambia a pendiente. Cuando se realiza la acción manualmente se cambia el estado a justificado 
            $table->timestamps();
        });
    }
